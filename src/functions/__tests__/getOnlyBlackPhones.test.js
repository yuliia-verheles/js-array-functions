const getOnlyBlackPhones = require('../getOnlyBlackPhones');
...
describe('getOnlyBlackPhones function', () => {
    test('return array of black phones', () => {
        const testBlackPhones = getOnlyBlackPhones(phones);
        expect(testBlackPhones).toEqual(blackPhones);
    });
});
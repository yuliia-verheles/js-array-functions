const getAvailablePhones = require('../getAvailablePhones');
...
describe('getAvailablePhones function', () => {
    test('return phones with "quantity <> 0"', () => {
        const testAvailablePhones = getAvailablePhones(phones);
        expect(testAvailablePhones).toEqual(availablePhones);
    });
});
const getProPhones = require('../getProPhones');
...
describe('getProPhones function', () => {
    test('return array of pro phones', () => {
        const testProPhones = getProPhones(phones);
        expect(testProPhones).toEqual(proPhones);
    });
});
const groupPhonesBySize = require('../groupPhonesBySize');
...
describe ('groupPhonesBySize function', () => {
    test ('try to group by size array of phone objects', () => {
        const groupedPhones = groupPhonesBySize(phones);
        expect(groupedPhones).toEqual(desiredArray);
    });
});
const addNewPhone = require('../addNewPhone');
...
describe('addPhone function', () => {
    test('should return array with new phone', () => {
        const testNewPhone = addNewPhone(newPhone, phones);
        expect(testNewPhone).toContainEqual(newPhone);
    });
});
